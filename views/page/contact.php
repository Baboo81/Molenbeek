        ...
        <section id="contact">
            <div id="contact-1">
                <div id="contact-info">
                    ...
                    <p>Envie de poser une question ? Besoin de plus d'informations sur les itinéraires, les points
                        d'intérest ou
                        sur
                        notre projet ? Avoir des suggestions de nouveaux itinéraires, ou des améliorations à
                        apporter à
                        notre
                        site
                        web ?</p>
                    ...
                    <p>Nous nous efforcerons de répondre le plus rapidement possible.</p>
                </div>
