        ...
        <div class="menu__container">
            ...
            <div class="menu__items">
                ...
                <div class="menu__dropdown">
                    ...
                    <a class="menu__item menu__item--sub">Molenbeek historique<i class="fa-solid fa-arrow-right"></i></a>
                </div>
            ...
            <form action="register.php" method="post" class="form">
                ...
                <div class="form__fields">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" name="password" id="password" class="input-group__input" placeholder="Entrez votre mot de passe" required>
                    </div>
                    <div class="input-group">
                        <label for="password" class="input-group__label">Répéter le mot de passe :</label>
                        <input type="password" name="password" id="password" class="input-group__input" placeholder="Entrez votre mot de passe" required>
                    </div>
                    <div class="input-group">
                        <label for="agree" class="input-group__label">
                            <input type="checkbox" name="agree" id="agree" value="oui" class="input-group__checkbox"/> Je suis d'accord avec 
                            <a href="#" title="term of services">les conditions de service</a>
                        </label>
                    </div>
                </div>
                <div class="button-wrapper form__submit">
                    <input class="btn btn-dark" type="submit" value="Inscrivez-vous">
                </div>
                <span class="form__help"><a href="">
